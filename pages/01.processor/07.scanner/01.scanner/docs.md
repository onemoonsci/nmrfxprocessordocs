...
The Scanner Tool can be used to process, visualize and analyze groups of spectra.  Intensity and integral measures are stored in a table and this tabular data can be exported for use in other applications. The Scanner Tool is accessed from the "Tools" menu in the lower left of the main spectrum window as follows:
