...
The Parameter Pane will be described in more detail below, but it gives access to information about the pulse sequence, solvent, temperature etc., and acquistion parameters for each dimension.
...
Now that the spectrum is well phased in the first dimension lets check out the 2nd (indirect) dimension.  Go to the Dimension menu ![](images/dim2.png) at the top of the Analyst window and select **2**.  
